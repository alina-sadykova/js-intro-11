...
console.log(diningTable.method());

// No inheritance
// console.log(officeTable.name); // undefined
// console.log(officeTable.adjustable); // undefined
// console.log(officeTable.method()); // TypeError: officeTable.method is not a function

console.log(diningTable.__proto__); //{ name: 'Table', adjustable: true, method: [Function: method] }
